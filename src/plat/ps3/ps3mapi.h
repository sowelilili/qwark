...
static __attribute__((unused)) void ps3mapi_get_process_name_by_id(u32 pid, char *name, u16 size)
{
	memset(name, 0, size);
	system_call_4(SC_COBRA_SYSCALL8, SYSCALL8_OPCODE_PS3MAPI, PS3MAPI_OPCODE_GET_PROC_NAME_BY_PID, (u64)pid, (u64)(u32)name);
}

static __attribute__((unused)) int ps3mapi_get_memory(u32 pid, u32 address, char *mem, u32 size)
{
    system_call_6(SC_COBRA_SYSCALL8, SYSCALL8_OPCODE_PS3MAPI, PS3MAPI_OPCODE_GET_PROC_MEM, (u64)pid, (u64)address, (u64)(u32)mem, size);
    return (int)p1;
}

static __attribute__((unused)) int ps3mapi_patch_process(u32 pid, u32 address, const char *new_value, int size)
{
